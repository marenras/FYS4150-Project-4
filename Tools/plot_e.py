...
T, E_40, C_V_40, M_40, chi_40, absM_40 		= np.loadtxt('../Data/40_lattice_test2.dat', unpack = True)
T, E_60, C_V_60, M_60, chi_60, absM_60		= np.loadtxt('../Data/60_lattice_test2.dat', unpack = True)
T, E_80, C_V_80, M_80, chi_80, absM_80 		= np.loadtxt('../Data/80_lattice_test2.dat', unpack = True)
T, E_100, C_V_100, M_100, chi_100, absM_100 = np.loadtxt('../Data/100_lattice_test2.dat', unpack = True)
